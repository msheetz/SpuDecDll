...
static int DecoderOpen( vlc_object_t *p_this )
{
	...
	//msg_Dbg(p_dec, "*********** BWAHAHAHAHA *************, called DecoderOpen!!!!");
	//myfile << "This is subtitle decode file.\n";
...
static int Decode( decoder_t *p_dec, block_t *p_block )
{
	...
	//msg_Dbg(p_dec, "Time values... i_pts: %lld, i_dts: %lld, i_length: %lld", p_spu_block->i_pts, p_spu_block->i_dts, p_spu_block->i_length);
